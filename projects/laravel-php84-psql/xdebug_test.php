<?php
/**
 * Xdebug Test File for PHP 8.4
 * Access: http://localhost:8010/xdebug_test.php
 */

echo "<h1>🐛 Xdebug Test - PHP 8.4</h1>";
...
$test_variable = "Hello from PHP 8.4 with Xdebug!"; // <- Set breakpoint here
$array_data = [
    'framework' => 'Laravel',
...
echo "<li>Configure your IDE to listen on port <strong>9084</strong></li>";
...
echo "<li><strong>Port:</strong> 8010 (web) / 9084 (debug)</li>";
echo "<li><strong>Path mapping:</strong> /app/laravel-php84-psql → your local project path</li>";
echo "</ul>";
?>
